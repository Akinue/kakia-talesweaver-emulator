using Kakia.TW.Shared.Configuration;
using Kakia.TW.Shared.Database;
using Kakia.TW.Shared.L10N;
...
namespace Kakia.TW.Shared
{
	...
	public abstract class Server
	{
		...
		public ConfFiles LoadConf()
		{
			...
			// Initialize stats calculator with loaded coefficients
			StatsCalculator.Initialize(this.Conf.Stats);
			Log.Info("Stats calculator initialized.");
		...
		protected void LoadLocalization(ConfFiles conf)
		{
			...
			Util.Localization.SetLocalizer(this.Localization.GetDefault());
		}
		...
		public void LoadData()
		{
			...
			//this.LoadDataFile(KakiaData.Features, "features.txt");

			//this.LoadDataFile(KakiaData.MapCache, cacheFileName);
		}
